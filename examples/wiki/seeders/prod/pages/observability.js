...
module.exports = {
  ...
  '  // ...protocol-specific config (e.g. { url, secret, retry, onDrop } for "webhook")',
  '  // onDrop({ reason, batch, error }) fires on overflow + retry-exhausted drops',
  '  // (operators wiring sinks outside the framework dispatcher rely on this',
  '  // for permanent-drop visibility).',
  '}</code></pre>',
