...
class UpdateBuilder extends Builder {
  ...
  // bridge, any adapter without interactive transactions). expected === null
  // becomes `col IS NULL` (since `col = NULL` is never true) so a null-state
  // fence works. The won/lost result is read from rowCount via b.sql.casWon.
