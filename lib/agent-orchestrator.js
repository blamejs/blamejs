 ...
 * @signature orchestrator.hydrate(name, agent)
 * @since     0.9.57
 * @status    stable
 * @related   b.agent.orchestrator.register, b.agent.orchestrator.lookup
 *
...
function _raceTimeout(p, budgetMs, label) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    // Unref so a misbehaving consumer doesn't keep the event loop alive
