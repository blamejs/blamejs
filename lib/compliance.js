...
var KNOWN_POSTURES = Object.freeze([
  ...
  // Records-preservation regimes that oblige row-level WORM. b.db refuses to
  // boot under any of these without a b.db.declareWorm declaration, so they
  // have to be settable for that refusal to be reachable at all.
