...
function _dmarcAuthorDomainLabels(domain) {
  ...
  // canonicalDomain strips the root marker in whichever spelling it arrived —
  // an absolute internationalized name may mark its root with U+3002 rather
  // than an ASCII dot, and UTS #46 only turns that into a dot during the
  // conversion. Compensating for it here instead would leave the authenticated
  // SPF and DKIM domains in a different canonical form from the Author Domain,
  // and a message would fail to align with itself.
