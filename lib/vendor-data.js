...
// (where applicable) and a description for the inventory surface. The
// actual `.data.js` module references live in `_MODULES` above — both
// tables share the same set of keys; the codebase-patterns drift gate
// enforces parity.
