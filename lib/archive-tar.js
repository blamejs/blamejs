...
// Lazy because guardFilename + guardArchive carry the full guard-family
// chain — write side doesn't need them; only extract does.
...
// Typeflags
var TF_REGULAR = "0";
var TF_REGULAR_LEGACY = "\u0000";   // some tars use NUL for regular
var TF_HARDLINK = "1";
var TF_SYMLINK = "2";
var TF_CHARDEV = "3";
var TF_BLOCKDEV = "4";
...
// H_DEVMAJOR / H_DEVMINOR — typeflag 3/4 (char/block device) entries
// are refused unconditionally at extract, so the framework never reads
// these fields. Kept for header-layout symmetry + future extract paths.
