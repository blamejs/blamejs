...
function _openSqlite(dbPath) {
  ...
  // Same SQLITE_LIMIT_* caps as db.init's main handle — the CLI opens the
  // operator's real database for migrate / inspect, so the parse-time DoS
  // floor (sqlLength) and the ATTACH denial apply here too.
