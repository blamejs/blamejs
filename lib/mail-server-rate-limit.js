...
function create(opts) {
  ...
  var concurrentByIp   = new Map();
  var connectionTimes  = new Map();
  var authFailureTimes = new Map();
  var rcptFailureTimes = new Map();
  ...
  function bodyRateStarved(bytes, elapsedMs) {
    ...
    if (!(elapsedMs >= BODY_RATE_GRACE_MS)) return false;
