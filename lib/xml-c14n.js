...
// { type, name, attrs, namespaces, children, text, parent }.
// Node types: "element" | "text" | "comment" | "processing".
//
// The parser is strict about what it refuses (DOCTYPE, ENTITY, CDATA
// with embedded `]]>`, processing instructions in unsafe positions);
// XML c14n is a security primitive and an over-permissive parser
// undermines the canonicalization guarantees downstream.
function parse(xml) {
