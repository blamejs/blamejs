...
// async-safe re-exports withRetry+CircuitBreaker from this module, so a
// direct require() here would create a cycle. Lazy-require defers the
// resolution until the first sleep() call, by which point both modules
// are fully loaded.
var asyncSafe = lazyRequire(function () { return require("./safe-async"); });
