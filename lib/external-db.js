...
// the first top-level (outside string-literal) semicolon — the
// multi-statement shape that would let a trailing DML hide behind a
// harmless leading keyword. Quote-aware: a `;` inside a '...' or "..."
// literal is data. Single linear pass — comment/whitespace skipping is
// an index walk, not a backtracking regex (CWE-1333).
