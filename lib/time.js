 ...
 *   can hand over a scripted one, which a closure over `Date.now` cannot.
 ...
 *
 * @opts
 *   source:     function,   // default: Date.now — must return a finite number of ms
 ...
 *   clock.observeFloor(tipRow.recordedAt);   // durable floor, read from storage
