...
function monotonicMs() {
  // Nanoseconds as a BigInt, divided in BigInt to microseconds first so the
  // Number conversion happens on a value small enough to keep sub-millisecond
  // precision instead of losing it to the float.
