...
function dbTicketStore(opts) {
  ...
  function _sealColumns(id, ticket) {
    ...
    // base64 is exactly 4/3; subtract a KiB for the vault nonce/tag/prefix.
    var maxPlaintextBytes = vaulted
      ? Math.floor(safeJson.ABSOLUTE_MAX_BYTES * 3 / 4) - C.BYTES.kib(1)
      : safeJson.ABSOLUTE_MAX_BYTES;
