...
function create(opts) {
  ...
  function commit(opts2) {
    ...
    if (opts2.retainPrevious && nodeFs.existsSync(paths.caCert)) {
      ...
      // Explicitly disabling retention must also clear a root a PRIOR retained
      // rotation left behind — otherwise loadTrustBundle() keeps trusting it
      // despite the caller opting out.
