...
function create(opts) {
  ...
  async function initCA() {
    if (exists()) {
      ...
      // Capture the algorithm pin WITH the CA snapshot so _leafEngineArgs binds the leaf to
      // the pin as of this read — a concurrent rotate({ algorithm }) that refreshes the mutable
      // caAlgorithm after this return cannot retarget an in-flight issuance's leaf.
