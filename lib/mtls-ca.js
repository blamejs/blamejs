...
function create(opts) {
  ...
  function _leafEngineArgs(ca, opts2) {
    ...
    // break a P-256/P-521 or custom-labeled engine that validates its option shape), and its
    // pin is never refreshed by commit() (that refresh is default-engine-only).
    var leafAlg = usesDefaultEngine ? _labelForCaKeyType(ca.caKeyPem) : caAlgorithm;
