...
function create(opts) {
  ...
  async function generateClientCert(opts2) {
    opts2 = opts2 || {};
    var ca = await initCA();
    // The CA's algorithm pin is the default; an explicit opts2.algorithm still
    // wins (Object.assign order) for a caller that wants a specific leaf.
    var args = Object.assign({ algorithm: caAlgorithm }, opts2,
