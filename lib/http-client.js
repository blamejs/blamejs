  ...
  return {
    request: function (opts) {
      if (pin !== null) {
        ...
        // because this is the host pin, not the scheme policy: the caller has
        // already applied its own, and one running against a loopback issuer
        ...
        if (host === null || !hostAllowed(host, pin, opts && opts.method)) {
