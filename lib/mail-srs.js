 ...
 *   // → "SRS0=<hash>=<tt>=bob.com=alice@forwarder.example", the hash keyed
 *   //   on the secret and the tt stamped from today
 *
 ...
 *   // → "SRS1=<hash>=forwarder.example==<hash>=<tt>=bob.com=alice@forwarder.example"
