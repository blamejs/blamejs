...
class DeprecationError extends FrameworkError {
  constructor(code, message) {
    super(message, code);
    this.name = "DeprecationError";
    this.permanent = true;
    this.isDeprecationError = true;
  }
}
...
function _validateOpts(opts, fnName) {
  if (!opts || typeof opts !== "object") {
    throw new DeprecationError("deprecate/bad-opts",
...
function warn(name, opts) {
  if (typeof name !== "string" || name.length === 0) {
    throw new DeprecationError("deprecate/bad-name",
  ...
  if (mode === "error") {
    throw new DeprecationError("deprecate/used-in-error-mode",
...
function wrap(fn, name, opts) {
  if (typeof fn !== "function") {
    throw new DeprecationError("deprecate/bad-target",
