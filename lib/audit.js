...
//
// Returns nothing — same fire-and-forget contract as emit(). Operators
// who need a hard guarantee that the event landed should call record()
// and await it with their own error handling.
