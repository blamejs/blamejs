...
function verifyCheckpoints() {
  ...
  for (var i = 0; i < rows.length; i++) {
    var c = rows[i];
    // Public key check: only the current key is accepted in v0.0.8. Future
    // key-rotation infrastructure (Phase 7) will introduce a key-history
    // table; for now, mismatch fails verification.
