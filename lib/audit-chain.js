...
function purgeAnchorSignatureVerifies(row, signature, publicKeyPem) {
  ...
  var layouts = [
    ...
    { layout: "no-checkpoint-digest", when: storedCkpt === "" },
    { layout: "no-digest",            when: storedCkpt === "" && storedDigest === "" },
    { layout: "no-range",             when: storedCkpt === "" && storedDigest === "" && storedRange === 0 },
  ];
