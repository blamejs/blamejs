...
function _validateCreateOpts(opts) {
  if (!opts || typeof opts !== "object") {
    throw _err("BAD_OPT", "i18n.create: opts must be an object");
  }
  ...
  if (opts.dir !== undefined && (typeof opts.dir !== "string" || opts.dir.length === 0)) {
    throw _err("BAD_OPT", "i18n.create: dir must be a non-empty string path");
  }
  if (opts.observability !== undefined && opts.observability !== null) {
    if (typeof opts.observability !== "object" ||
      ...
      throw _err("BAD_OPT", "i18n.create: observability must be a b.observability-shaped object");
    }
  }
  if (opts.clock !== undefined && typeof opts.clock !== "function") {
    throw _err("BAD_OPT", "i18n.create: clock must be a function");
  }
}
