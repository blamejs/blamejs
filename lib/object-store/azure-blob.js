...
function create(config) {
  ...
  function presignedUploadUrl(_opts) {
    // Azure SAS (Shared Access Signature) URL generation requires
    // string-to-sign assembly distinct from the Shared Key auth used by
    // put/get. Not yet implemented — operators with Azure-only deployments
    // should request this primitive and we'll add it.
    throw _err("PRESIGN_NOT_SUPPORTED",
      "azure-blob backend does not yet support SAS-based presigned uploads",
      true);
  }
