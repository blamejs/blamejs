...
function create(config) {
  ...
  function presignedUploadUrl(_opts) {
    // GCS V4 signing requires service-account RSA-SHA256 signing of the
    // canonical request. Not yet implemented — operators needing presigned
    // uploads for GCS-hosted buckets should provision an S3-interop HMAC
    // key and use protocol: 'sigv4' with endpoint:
    // 'https://storage.googleapis.com'.
    throw _err("PRESIGN_NOT_SUPPORTED",
      "gcs backend does not yet support native V4 presigning — use the S3 " +
      "interop endpoint via protocol: 'sigv4' with endpoint: " +
      "'https://storage.googleapis.com' for now", true);
  }
