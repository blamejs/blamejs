...
// The capture group is the raw URL up to the closing paren or the
// optional title. Reference-style definitions ([id]: url) are caught by
// the third pattern so EchoLeak reference-link payloads don't slip past.
