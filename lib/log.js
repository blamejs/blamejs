 ...
 *   // writes, on a TTY: [blamejs:db] ready
 *   // and when piped:   {"timestamp":"...","level":"info","message":"ready",
 *   //                    "component":"db","boot":true}
 */
function boot(name) {
 ...
 *   // writes: [blamejs:bundler] build-failed {"reason":"missing entrypoint"}
 */
