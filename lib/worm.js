...
function create(opts) {
  ...
  function get(id) {
    ...
    return { id: id, data: rec.bytes, digest: rec.digest.toString("hex"), createdAt: rec.createdAt, retainUntil: rec.retainUntil, legalHolds: rec.legalHolds.slice(), mode: rec.mode };
  }
