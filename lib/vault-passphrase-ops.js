...
class VaultPassphraseError extends FrameworkError {
  constructor(code, message) {
    super(message, code);
    this.name = "VaultPassphraseError";
    this.permanent = true;
    this.isVaultPassphraseError = true;
  }
}
...
function _fsyncPath(p) {
  ...
  } catch (_e) { /* Windows / non-supporting filesystems — best-effort */ }
}
