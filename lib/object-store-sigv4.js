...
// Default response-body caps. Control-plane (PUT/HEAD/DELETE) responses
// are confirmations. LIST returns XML — sizable but bounded. GET returns
// the actual stored object — operators with > 1 GiB files should use
// getStream() instead.
