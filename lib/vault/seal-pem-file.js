  ...
  function _resealNow(actor) {
    ...
    try {
      ...
      try {
        ...
        // An operator callback that fails is captured in audit rather than
        // dropped silently — whether it threw or returned a rejected promise.
      ...
      // An operator callback that fails lands in audit rather than being
      // dropped silently — whether it threw or returned a rejected promise.
