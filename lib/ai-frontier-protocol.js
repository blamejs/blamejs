 ...
 *   notification deadline to the California Office of Emergency Services: within
 *   15 days of discovery, or within 24 hours when there is an imminent risk of
...
var CRITICAL_INCIDENT_TYPES = {
  "weights-exfiltration-harm":         "Unauthorized access, modification, or exfiltration of model weights resulting in death, bodily injury, or property loss",
  "catastrophic-risk-materialization": "Harm resulting from the materialization of a catastrophic risk",
...
function incidentReport(opts) {
  ...
  return {
    ...
    recipient:          "California Office of Emergency Services",
    citation:           "Cal. Bus. & Prof. Code §22757.10 et seq. (SB 53)",
  };
}
