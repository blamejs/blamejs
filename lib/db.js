...
// exportCsv — RFC 4180 strict CSV export of a single table, with
// optional WHERE clause filter, optional UTF-8 BOM, ISO-8601 timestamp
// projection, SHA3-512 manifest, and ML-DSA-87 audit-sign signature.
//
//   var out = await b.db.exportCsv({
//     table:       "orders",
//     where:       { status: "shipped" },
//     columns:     ["_id", "createdAt", "totalCents"],   // optional projection
//     bom:         true,                                  // U+FEFF prefix
//     signWith:    b.auditSign,                            // optional signer
//     timestampFields: ["createdAt", "updatedAt"],         // ms→ISO-8601 cast
//   });
//   // → { csv, bytesWritten, sha3_512, signature?, manifest, rowCount }
//
// signWith — operator passes b.auditSign (or any object exposing
// sign(payload) → Buffer + getPublicKey() + getAlgorithm() +
// getPublicKeyFingerprint()) to attach a detached signature over the
// CSV bytes.
