 ...
 *   resolvePurgeArchive:     function,         // (archiveBundleId) => truthy if that archive can still be produced; boot refuses a purge boundary whose archive has gone missing
