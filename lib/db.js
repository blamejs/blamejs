...
function resolveTmpDir(optsTmpDir) {
  ...
  var envTmp = envSafe.readVar("BLAMEJS_TMPDIR");
...
async function init(opts) {
  ...
  var auditSigningMode = (opts.auditSigning && opts.auditSigning.mode)
    ...
    : envSafe.readVar("BLAMEJS_AUDIT_SIGNING_MODE", {
        default: "wrapped",
...
async function _runNtpBootCheck(opts) {
  if (envSafe.readVar("BLAMEJS_SKIP_NTP_CHECK", { default: "" }) === "1") return;
  var ntpCheck;
  ...
  if (result.severity === "info") {
    ...
    if (envSafe.readVar("BLAMEJS_NTP_STRICT", { default: "1" }) !== "0") {
