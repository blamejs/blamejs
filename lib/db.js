...
async function init(opts) {
  ...
  // would otherwise be parsed. attach=0 denies ATTACH DATABASE — the framework
  // never uses ATTACH (verified), and it is an exfiltration / shadow-schema
  // escalation vector. The limits option is part of node:sqlite from Node
  // 24.10+, comfortably under the engines floor.
