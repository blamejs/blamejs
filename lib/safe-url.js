...
// RFC 9112 §3 recommended 8000 octets, RFC 9110 doesn't update.
 ...
 * sees the input (RFC 9112 §3 — 8 KiB default), protocol
 ...
 *   maxUrlLength:     number,     // default 8192 (RFC 9112 §3)
...
function parse(url, opts) {
  ...
  if (typeof url === "string" && url.length > maxUrlLength) {
    throw _makeError(errClass, "safe-url/too-long",
      ...
      "). RFC 9112 §3 recommends 8000; pass opts.maxUrlLength to override.");
  }
