 ...
 *   //    "font-weight-degradation", "login-required-only-for-cancel"]
 *
 *   // The extra confirmation step is not among them: `requireSameConfirmations`
 *   // belongs to the `ca-sb942` and `strict` postures, and the same pair under
 *   // either of those reports `confirmation-step-added` too.
 */
