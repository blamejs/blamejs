...
function _ambiguityFindings(src, flags) {
  ...
  if (ast === null) {
    ...
    // is the opposite direction from screening input with one. Nothing an
    // attacker supplies is matched here; a pattern that does not compile simply
    // reports as not-a-regex.
