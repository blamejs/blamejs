...
// RestrictionType (2) + a range list of vendor ids. A minimal / byte-
// truncated core may end before this field — fewer than 12 bits left
// means there are simply no restrictions.
function _parsePublisherRestrictions(r) {
  var out = [];
  if (r.remaining() < 12) return out;                                                          // allow:raw-byte-literal — TCF spec field width
