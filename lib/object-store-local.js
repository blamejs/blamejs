 ...
 * full files (unlike the v0.0.5 storage.js path which allocated whole
 * Buffers).
 *
 * Path safety: every key resolves under the configured rootDir, with the
 * same alphanumeric+/-./_-only charset and traversal-rejection rules as
 * v0.0.5 storage.
 */
var fs = require("fs");
