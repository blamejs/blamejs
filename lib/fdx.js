...
function bind(opts) {
  ...
  validateOpts.shape(opts.authServer, {
    issuer:  { rule: "required-string", code: "fdx/bad-issuer",   label: "fdx.bind: authServer.issuer" },
    jwksUri: { rule: "required-string", code: "fdx/bad-jwks-uri", label: "fdx.bind: authServer.jwksUri" },
...
function consentReceipt(opts) {
  ...
  validateOpts.shape(opts, {
    dataProvider:  { rule: "required-string", code: "fdx/bad-data-provider" },
    consumerRef:   { rule: "required-string", code: "fdx/bad-consumer-ref" },
    thirdParty:    { rule: "required-string", code: "fdx/bad-third-party" },
    revocationUrl: { rule: "required-string", code: "fdx/bad-revocation-url" },
    ...
    durationMs: function (value, label) {
      numericBounds.requirePositiveFiniteIntIfPresent(value, label, FdxError, "fdx/bad-duration");
    },
