 ...
 * directory is left alone however long it has been running. The activity
 * scan reads at most 4,096 entries and gives up on an unreadable one; a
 * scan it could not finish keeps the directory rather than guessing that
 * the part it did not read is idle. A name listed in
