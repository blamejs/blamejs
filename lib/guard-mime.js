...
var RESTRICTED_NAME_MAX = 127;

var _isParamToken = safeBuffer.isHttpToken;

var QUOTED_STRING_BODY_RANGES = [0x0009, [0x0020, 0x007E]];
 ...
 *   bad.ok;                                            // → false
 *   bad.issues[0].ruleId;                              // → "mime.unregistered-tree"
 *   bad.issues[1].ruleId;                              // → "mime.risky-type"
 */
