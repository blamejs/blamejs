 ...
 * @since     0.8.62
 * @status    stable
 * @related   b.auth.oid4vp.verifier
 *
 ...
 * @since     0.8.62
 * @status    stable
 * @related   b.auth.sdJwtVc.verify, b.auth.oid4vp.matchDcql
 *
...
function create(opts) {
   ...
   * @signature verifier.createRequest({ dcql })
   * @since     0.8.62
   *
   ...
   * @signature verifier.verifyResponse({ vpToken, dcql, nonce })
   * @since     0.8.62
   *
