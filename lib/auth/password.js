...
// Minimal common-password seed list. Operators with a real "top N"
// list pass it via opts.forbidCommon; this seed is a "if these get
// through, you've configured no policy at all" bottom floor.
var SEED_COMMON_PASSWORDS = Object.freeze([
  "password", "12345678", "123456789", "qwerty123", "letmein123",
  "password1", "admin1234", "welcome1", "iloveyou1",
  "passw0rd", "password123", "qwertyuiop", "1qaz2wsx", "zxcvbnm1",
  "monkey123", "dragon123", "trustno1", "iloveyou", "master12",
]);
