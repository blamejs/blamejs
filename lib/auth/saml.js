...
function create(opts) {
  ...
  function buildLogoutRequest(bopts) {
    ...
    if (bopts.signingKey || bopts.signingAlg) {
      var isPqcOrEd = bopts.signingAlg === "ml-dsa-65" ||
                      bopts.signingAlg === "ml-dsa-87" ||
                      bopts.signingAlg === "ed25519";
      if (isPqcOrEd && bopts.signingAlg !== "ed25519" && !(bopts.signingKey instanceof Uint8Array)) {
        throw new AuthError("auth-saml/bad-signing-key",
          "buildLogoutRequest: signingKey for " + bopts.signingAlg + " must be a Uint8Array");
      }
      if (!isPqcOrEd && typeof bopts.signingKey !== "string" &&
          !(bopts.signingKey && typeof bopts.signingKey === "object" && bopts.signingKey.type === "private")) {
        throw new AuthError("auth-saml/bad-signing-key",
  ...
  function buildLogoutResponse(bopts) {
    ...
    if (bopts.signingKey || bopts.signingAlg) {
      var isPqcOrEdR = bopts.signingAlg === "ml-dsa-65" ||
                       bopts.signingAlg === "ml-dsa-87" ||
                       bopts.signingAlg === "ed25519";
      if (isPqcOrEdR && bopts.signingAlg !== "ed25519" && !(bopts.signingKey instanceof Uint8Array)) {
        throw new AuthError("auth-saml/bad-signing-key",
          "buildLogoutResponse: signingKey for " + bopts.signingAlg + " must be a Uint8Array");
      }
      if (!isPqcOrEdR && typeof bopts.signingKey !== "string" &&
          !(bopts.signingKey && typeof bopts.signingKey === "object" && bopts.signingKey.type === "private")) {
        throw new AuthError("auth-saml/bad-signing-key",
