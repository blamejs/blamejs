...
async function parse(jar, opts) {
  ...
  // RFC 9101 §5.2 — the request object's client_id claim MUST match
  // the client. (verifyExternal already pinned iss === clientId; this
  // pins the OAuth client_id claim too.)
  if (payload.client_id !== undefined && payload.client_id !== opts.clientId) {
