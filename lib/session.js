  ...
  if (opts.merge === true && existing && typeof existing === "object") {
    ...
    if (data && typeof data === "object") {
      Object.keys(data).forEach(function (k) {
        ...
        // ONE LEVEL DEEP (per the doc): a plain-object value merges into the existing plain object so
        // its keys survive; an array or a non-object value REPLACES wholesale. Deeper than one level
        // replaces — Object.assign copies the inner object's own keys, not recursively.
