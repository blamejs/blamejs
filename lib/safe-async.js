...
class AsyncSafeError extends FrameworkError {
...
// sleep cleanly — the wrapper rejects with AsyncSafeError(async/aborted).
//
...
function sleep(ms, opts) {
  if (typeof ms !== "number" || !Number.isFinite(ms)) {
    return Promise.reject(new AsyncSafeError(
