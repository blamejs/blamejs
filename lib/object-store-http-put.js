...
function create(config) {
  ...
  function getStream(key) {
    // We don't have a streaming ergonomic path through Node's https that
    // doesn't buffer; return a Readable wrapping the buffered body for now.
    // Real chunked streaming lands when SigV4 protocol arrives in v0.0.10.
