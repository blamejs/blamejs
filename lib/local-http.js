...
function _isLoopbackHost(host) {
  ...
  // Strip a single trailing root-zone dot ("localhost." resolves to localhost)
  // before the equality compare — an FQDN form must not slip the loopback set.
  ...
  function request(ropts) {
    return new Promise(function (resolve, reject) {
      ...
      req.setTimeout(timeoutMs, function () {
        fail(new LocalHttpError("local-http/timeout", "request: no response within " + timeoutMs + "ms"));
      });
