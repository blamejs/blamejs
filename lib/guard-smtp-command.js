 ...
 * @signature b.guardSmtpCommand.detectBodySmuggling(buf, isBodyStart?)
 * @since     0.9.46
 * @status    stable
...
// there. Every other shape here reads at most one byte back, which a scanner
// covers by overlapping its windows.
function detectBodySmuggling(buf, isBodyStart) {
