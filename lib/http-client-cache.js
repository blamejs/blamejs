...
function _parseCacheControl(value) {
  ...
  // backslash-escape).
  var parts = _splitTopLevelCommas(value);
...
// _splitTopLevelCommas. Tracks RFC 8941 §3.3.3 quoted-string state
// with backslash-escape so a quoted directive value containing `,`
