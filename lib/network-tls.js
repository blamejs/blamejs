...
// Bumped whenever the group preference changes. Anything that CACHES built
// TLS options — a pooled https.Agent, a long-lived SMTP transport — stamps
// the generation it was built under and rebuilds when it no longer matches.
// Without it, "the next dial picks up the change" holds only for callers that
// construct their options fresh, and a connection pool quietly keeps offering
// the groups the operator removed for as long as it lives.
