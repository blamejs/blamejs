...
// The local hrtime→ms conversion this used to carry now lives on the surface
// as b.time.monotonicMs, which is where a consumer measuring a duration will
// look for it. A token-bucket refill is exactly what it is for: the budget has
// to depend on how much time passed, not on what the clock says it is.
function _hrtimeMs() {
