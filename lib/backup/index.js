...
function bundleAdapterStorage(opts) {
  ...
  var passphraseMinEntropyBits = typeof opts.passphraseMinEntropyBits === "number"
    ? opts.passphraseMinEntropyBits : 80;                                             // allow:raw-byte-literal — entropy-bits floor, not byte count
