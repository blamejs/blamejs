...
var CATALOGS = {
  "800-53r5": {
    ...
    controls: {
      ...
      "AC-4":  { name: "Information Flow Enforcement", primitives: ["b.middleware.cors", "b.ssrfGuard", "b.httpClient.request", "b.middleware.networkAllowlist"] },
      ...
      "AC-12": { name: "Session Termination", primitives: ["b.session", "b.auth.atoKillSwitch"] },
      ...
      "AU-9":  { name: "Protection of Audit Information", primitives: ["b.audit", "b.audit.checkpoint", "b.configDrift"] },
      "AU-10": { name: "Non-repudiation", primitives: ["b.audit.checkpoint", "b.webhook.sign", "b.crypto.httpSig"] },
      ...
      "CP-9":  { name: "System Backup", primitives: ["b.backup", "b.backup.scheduleTest", "b.backup.verifyManifestSignature"] },
      ...
      "IR-4":  { name: "Incident Handling", primitives: ["b.incident", "b.incident.report", "b.auth.atoKillSwitch"] },
      ...
      "SC-7":  { name: "Boundary Protection", primitives: ["b.ssrfGuard", "b.middleware.cors", "b.middleware.networkAllowlist", "b.httpClient.request"] },
      ...
      "SI-7":  { name: "Software, Firmware, and Information Integrity", primitives: ["b.configDrift.verifyVendorIntegrity", "b.audit.checkpoint"] },
  ...
  "csf-2.0": {
    ...
    controls: {
      ...
      "RS.MI":  { name: "Incident Mitigation",         primitives: ["b.auth.atoKillSwitch"] },
  ...
  "800-171r3": {
    ...
    controls: {
      ...
      "03.03.08": { name: "Audit Log Protection",          primitives: ["b.audit.checkpoint"] },
