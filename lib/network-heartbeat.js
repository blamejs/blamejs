...
function passive(opts) {
  ...
  if (opts.onPong !== undefined && typeof opts.onPong !== "function") {
    throw new HeartbeatError("heartbeat/bad-on-pong",
      "heartbeat.passive: onPong must be a function when supplied");
  }
