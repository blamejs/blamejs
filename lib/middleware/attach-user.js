...
function _readBearer(authHeader, scheme) {
  ...
  // allow:dynamic-regex — schemeTok is RegExp-escaped via codepointClass.escapeRegExp, so the operator-supplied scheme matches literally and cannot inject a pattern
