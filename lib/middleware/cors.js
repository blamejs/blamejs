...
var ORIGIN_PATTERN_PROBE = "https://blamejs-cors-anchor-probe.invalid";
...
function _anchoredOriginPattern(re, idx) {
  ...
  if (anchored.test("") || anchored.test(ORIGIN_PATTERN_PROBE)) {
    throw new CorsError("cors/overbroad-pattern",
      ...
      "host(s) you trust rather than a catch-all");
  }
  return anchored;
}
