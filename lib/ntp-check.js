 ...
 *   ntsServers: ["time.cloudflare.com", "nts.example:4460", "[2001:db8::1]:4460"],   // host, host:port or [v6]:port — tried first, authenticated (RFC 8915)
 *   requireNts: false,                     // no unauthenticated fallback when true
 *   port:      123,
 *   timeoutMs: 3000,
 *
 * @example
