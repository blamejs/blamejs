 ...
 *   bytes (other than TAB inside QUOTED-PRINTABLE-shaped values), DEL
 *   (0x7F), and C1 controls (U+0080-U+009F) inside property values. Defends against downstream
 ...
 *   C1 inside property values; allowlists property names; defends the
...
function _preview(s) {
  return safeBuffer.previewText(s);
}
