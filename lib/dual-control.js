...
function create(opts) {
  ...
  validateOpts.requireNonEmptyString(opts.namespace, "create: opts.namespace", DualControlError, "dual-control/bad-opt");
  if (!opts.cache || typeof opts.cache.get !== "function" || typeof opts.cache.set !== "function") {
    throw _err("dual-control/bad-opt", "create: opts.cache is required (a b.cache instance)");
  }
  var ttlMs = opts.ttlMs !== undefined ? opts.ttlMs : DEFAULTS.ttlMs;
  if (typeof ttlMs !== "number" || !isFinite(ttlMs) || ttlMs <= 0) {
    throw _err("dual-control/bad-opt", "create: ttlMs must be a positive finite number");
  }
  ...
  if (typeof minApprovers !== "number" || !isFinite(minApprovers) ||
    ...
    throw _err("dual-control/bad-opt", "create: minApprovers must be an integer >= 2 (dual-control by definition needs 2+)");
  }
  ...
  if (typeof consumeLockMs !== "number" || !isFinite(consumeLockMs) || consumeLockMs < 0) {
    throw _err("dual-control/bad-opt", "create: consumeLockMs must be a non-negative finite number");
  }
  ...
  if (typeof minReasonLength !== "number" || !isFinite(minReasonLength) || minReasonLength < 0 ||
    ...
    throw _err("dual-control/bad-opt", "create: minReasonLength must be a non-negative integer");
  }
  ...
  if (approverRoles !== null) {
    if (!Array.isArray(approverRoles) || approverRoles.length === 0 ||
      ...
      throw _err("dual-control/bad-opt", "create: approverRoles must be null or a non-empty array of role-name strings");
    }
  }
  var notifyFn = opts.notify;
  if (notifyFn !== undefined && notifyFn !== null && typeof notifyFn !== "function") {
    throw _err("dual-control/bad-opt", "create: notify must be a function (event) => void or null");
  }
  ...
  async function request(args) {
    if (!args || typeof args !== "object") {
      throw _err("dual-control/bad-arg", "request: args object required");
    }
    if (typeof args.action !== "string" || args.action.length === 0) {
      throw _err("dual-control/bad-arg", "request: args.action (string) is required");
    }
    var requesterId = _actorIdOf(args.requestedBy);
    if (!requesterId) {
      throw _err("dual-control/bad-arg", "request: args.requestedBy must be an actor with a stable id");
    }
  ...
  async function cancel(args) {
    if (!args || typeof args !== "object") throw _err("dual-control/bad-arg", "cancel: args required");
  ...
  async function _load(grantId) {
    if (typeof grantId !== "string" || grantId.length === 0) {
      throw _err("dual-control/bad-arg", "grantId (string) is required");
    }
  ...
  async function approve(args) {
    if (!args || typeof args !== "object") throw _err("dual-control/bad-arg", "approve: args required");
    var approverId = _actorIdOf(args.approver);
    if (!approverId) throw _err("dual-control/bad-arg", "approve: args.approver must be an actor with a stable id");
  ...
  async function revoke(args) {
    if (!args || typeof args !== "object") throw _err("dual-control/bad-arg", "revoke: args required");
