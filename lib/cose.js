...
// COSE_Key EC2 curve identifiers (RFC 9053 §7.1) → JWK crv names.
var COSE_EC2_CRV = { 1: "P-256", 2: "P-384", 3: "P-521", 8: "secp256k1" };   // allow:raw-byte-literal — COSE EC2 curve ids (RFC 9053), not sizes
var COSE_KTY_OKP = 1;
var COSE_KTY_EC2 = 2;
 ...
 * P-256 / P-384 / P-521 / secp256k1) and OKP (<code>kty</code> 1:
 * Ed25519) key types; the curve is allowlisted, so an unexpected key
 * type is refused rather than imported. The verification key embedded in
 * an mdoc MSO or a COSE_Key header is consumed this way.
 *
 * @example
