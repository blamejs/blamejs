...
function _algParamsFor(algId) {
  switch (algId) {
    case -50: return { nodeAlg: null };
    case -8:  return { nodeAlg: null };
    case -7:  return { nodeAlg: "sha256", dsaEncoding: "ieee-p1363" };
    case -35: return { nodeAlg: "sha384", dsaEncoding: "ieee-p1363" };
    case -36: return { nodeAlg: "sha512", dsaEncoding: "ieee-p1363" };
    default:
...
var _ALG_KEY_TYPE = { EdDSA: "ed25519", "ML-DSA-87": "ml-dsa-87" };
...
async function sign(payload, opts) {
  ...
  _assertAlgKeyMatch(opts.alg, key);
...
async function verify(coseSign1, opts) {
  ...
  _assertAlgKeyMatch(algName, key);
...
function encrypt0(plaintext, opts) {
  ...
  var ciphertext = Buffer.concat([ct, cipher.getAuthTag()]);
