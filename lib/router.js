...
class Router {
  ...
  _check0RttReplay(req) {
    ...
    // The authority the request named, whichever form it arrived in: node maps
    // neither `Host` nor `:authority` into the other, so hashing only the
    // former left every HTTP/2 request sharing an empty component here.
