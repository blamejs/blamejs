...
// b.router.create(opts) — factory mirroring the framework's create()
// convention. Equivalent to `new Router(opts)`. Opts:
//
//   tls0Rtt:  "refuse" | "replay-cache"   (default "refuse")
//             RFC 8446 §8 anti-replay posture for TLS 1.3 0-RTT
//             early-data. Posture-asserted regimes (`pci-dss`,
//             `fapi2`) override "replay-cache" → "refuse" at listen
//             time and emit a `tls.0rtt.refused` audit row with
//             reason `posture-failclosed`.
