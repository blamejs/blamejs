 ...
 *   // → the placeholder the cluster's own backend takes
 */
function dialect() {
 ...
 *   // → the endpoint this node registered with b.cluster.init,
 *   //   "https://api-01.example.internal:8443" say, and null before it
 */
function endpoint() {
 ...
 *   // → the token this node's current lease carries, 42 say, and 0 before
 *   //   b.cluster.init or while this node holds no lease
 */
