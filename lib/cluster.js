...
function _isMissingTableError(e) {
  if (!e) return false;
  // Structured code / SQLSTATE first — driver-stable, locale-independent, and
  // shared with every other caller that has to tell an absent table from a
  // failed query. Only the message test below is this caller's own.
