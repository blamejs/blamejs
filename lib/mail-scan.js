 ...
 *     `mail-scan/icap-status` is an ICAP response whose status is neither 200
 *     nor 204, and `icapResponse` carries the parsed response alongside it. On
 *     the clamav-instream backend,
