...
function _validateCreateOpts(opts) {
  ...
  // contentSafety — operator-supplied gates per file extension. Each
  // value must be a gate satisfying the b.gateContract shape (check fn).
  // Example:
  //   contentSafety: { ".csv": b.guardCsv.gate({ profile: "strict" }) }
  validateOpts.optionalPlainObject(opts.contentSafety,
    "staticServe.create: contentSafety", StaticServeError, "BAD_OPT",
    "must be a plain { ext: gate } object");
...
function create(opts) {
  ...
  var contentSafety   = opts.contentSafety || null;
