...
// what the lazy `[\s\S]*?` between the two said, one pass rather than a
// pattern.
...
// Velocity directives — `#` then a directive name, matched without regard to
// ASCII case and not running into a further identifier character (`#ends` is
// not `#end`).
