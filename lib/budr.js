...
function declare(opts) {
  ...
  numericBounds.requirePositiveFiniteIntIfPresent(opts.rtoMs, "budr.declare: rtoMs", BudrError, "budr/bad-rto");
  numericBounds.requirePositiveFiniteIntIfPresent(opts.rpoMs, "budr.declare: rpoMs", BudrError, "budr/bad-rpo");
  ...
  validateOpts.optionalNonEmptyString(opts.owner,
    "budr.declare: owner", BudrError, "budr/bad-owner");
