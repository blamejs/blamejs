...
function _baseSchema(spec) {
  ...
  s.parse = function (input) {
    var r = _withParse(input, function () { return _runWithModifiers(s, input, _rootPath()); });
  ...
  s.safeParse = function (input) {
    var r;
    try {
      r = _withParse(input, function () { return _runWithModifiers(s, input, _rootPath()); });
    } catch (e) {
      if (e instanceof SafeSchemaError && e.code === "safe-schema/evaluation-limit") {
