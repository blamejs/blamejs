 ...
 *
 * Future-slice integration:
 *   - forms.validate (HTML form spec validation) becomes a thin wrapper
 *     over safe-schema in a Phase 9 follow-up. Today the surfaces are
 *     separate because the form spec carries HTML-specific concerns
 *     (checkbox coercion, select option allowlist) that don't belong
 *     on the general-purpose validator.
 */
