 ...
 *
 * Composition over invention: every helper threads through an existing
 * framework primitive instead of re-rolling timer races or polling loops.
 *
 *   var t = b.testing;
 ...
 *   } finally { dir.cleanup(); }
 *
 * Primitive-mapping (per feedback_compose_existing_primitives.md):
 *
