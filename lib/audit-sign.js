 ...
 * supported as opt-in alternatives for throughput-sensitive
 * deployments. SLH-DSA-SHAKE-256f is hash-only — its security depends
 * solely on the underlying hash function, with no lattice / module-
 * hardness assumptions — and matches the framework's SHAKE256 KDF +
 * SHA3-512 hash family. Audit checkpoints are long-lived integrity
