...
function create(opts) {
  ...
  return {
    // Read surface — backed by v0.9.19 store immediately.
    search:    function (args) { return _search(ctx, args); },
    fetch:     function (args) { return _fetch(ctx, args); },
    thread:    function (args) { return _thread(ctx, args); },
    folders:   function (args) { return _folders(ctx, args); },
    quota:     function (args) { return _quota(ctx, args); },
    ...
    // Move / flag / delete — backed by store.
    move:      function (args) { return _move(ctx, args); },
    flag:      function (args) { return _flag(ctx, args); },
    delete:    function (args) { return _delete(ctx, args); },
