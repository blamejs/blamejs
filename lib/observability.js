...
function _parseTraceparent(headerValue) {
  ...
  if (!m) return null;
  if (m[2] === _ALL_ZERO_TRACE) return null;
  if (m[3] === _ALL_ZERO_PARENT) return null;
...
var _TRACESTATE_VALUE_RE = /^[\x20-\x2B\x2D-\x3C\x3E-\x7E]{1,256}$/;
...
var _BAGGAGE_MAX_CHARS = C.BYTES.kib(8);
