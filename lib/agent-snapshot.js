...
function _contentHash(snap) {
  ...
  // signed bytes stay bounded (a 49,856-byte SLH-DSA-SHAKE-256f
  // signature — the default this signs under — or a 3,309-byte
  // ML-DSA-65 one shouldn't have to cover a 50 MiB envelope's payload).
  var body = {
