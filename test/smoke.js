...
// async-safe + handlers + sql-safe + chain-writer test definitions live
// in ./00-primitives.js (Layer 0). Smoke runner calls primitivesLayer.run()
...
(async function () {
  ...
  // async-safe + handlers + sql-safe + chain-writer all extracted to
  // test/00-primitives.js. primitivesLayer.run() invokes them in order.
